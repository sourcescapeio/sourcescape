...
//     nodeHint:      Option[NodeType])(implicit targeting: QueryTargeting[TU], context: SpanContext): Flow[GraphTrace[TU], EdgeHop[GraphTrace[TU]], Any] = {
...
//         context.withSpan("elasticsearch.query.initialize") { _ =>
//           for {
...
//           } yield {
//             context.withSpanS(
//               s"elasticsearch.query.consume",
//               "count" -> cnt.toString()) { _ =>
//                 src
//               }
//           }
//         }
