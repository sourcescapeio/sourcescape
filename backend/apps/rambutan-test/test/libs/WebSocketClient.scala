 ...
 * https://github.com/playframework/playframework/blob/2.8.x/core/play-integration-test/src/it/scala/play/it/http/websocket/WebSocketClient.scala
 */
...
object WebSocketClient {
  ...
  private class DefaultWebSocketClient extends WebSocketClient {
    ...
    def connect(url: URI, version: WebSocketVersion, subprotocol: Option[String])(
      onConnected: (immutable.Seq[(String, String)], Flow[ExtendedMessage, ExtendedMessage, _]) => Unit): Future[Unit] = {
  ...
  private class WebSocketSupervisor(
    ...
    def webSocketProtocol(
      clientConnection: Flow[WebSocketFrame, WebSocketFrame, _]): Flow[ExtendedMessage, ExtendedMessage, _] = {
