...
trait IndexHelpers {
  self: GuiceOneAppPerSuite with MockitoSugar =>

  protected def runIndex(index: RepoSHAIndex, indexType: IndexType)(data: (String, String)*)(implicit ec: ExecutionContext) = {
